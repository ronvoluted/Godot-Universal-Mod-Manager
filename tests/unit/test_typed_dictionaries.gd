...
func test_game_data_get_var_returns_typed_dictionary() -> void:
	var game := GameData.new({entry_path = "/test", game_path = "/gp", installed_mods = []})
...
func test_game_data_get_var_preserves_values() -> void:
	var game := GameData.new({entry_path = "/test/path", game_path = "/gp/path", installed_mods = []})
	var result := game.get_var()
...
func test_typed_dict_round_trip_via_var_to_str() -> void:
	var game := GameData.new({entry_path = "/rt", game_path = "/gp", installed_mods = []})
